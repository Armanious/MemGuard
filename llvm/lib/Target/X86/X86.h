...
/// This pass instruments memory reads/writes to prevent access to the lower part
/// of the address space - a safe region.
FunctionPass *createX86MemGuardPass();
ModulePass *createIRMemGuardPass();
bool isMemGuardEnabled();
bool isMemGuardMPXEnabled();
